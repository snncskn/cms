...
@Component({
  ...
  styleUrls: ['./supplier-modal.component.css', './supplier-modal.component.scss'],
...
export class SupplierModalComponent implements OnInit, AfterViewInit {
    ...
    this.supplierService.find(uuid).subscribe(data => {
      ...
      data.data.contacts.forEach(item => {
        this.rows.push(new FormGroup({
          ...
          landLine: new FormControl({ value: item.landLine, disabled: false }, Validators.required),
  ...
  public createRegisterForm(): void {
    ...
    this.supplierForm.controls['uuid'].disable();
    this.supplierForm.controls['name'].disable();
    this.supplierForm.controls['address'].disable();
    this.supplierForm.controls['registerNumber'].disable();
    this.supplierForm.controls['taxNumber'].disable();
    this.supplierForm.controls['imageUuid'].disable();
