...
export class ItemTypeComponent implements OnInit {
  ...
  constructor(private readonly itemTypeService: ItemTypeService,
    private readonly attrService: ItemAttributesService,
  ...
  public ngOnInit(): void {
    ...
    this.activatedRouter.paramMap.subscribe(params => {
      if (params.has('id')) {
        ...
        this.itemTypeService.find(params.get('id')).subscribe(data => {
  ...
  public ngOnSubmit(): void {
    ...
    this.vehicleTypeDto.vehicleTypeDesc = this.frmGroup.value.name.toUpperCase();
    ...
    this.itemTypeService.save(this.vehicleTypeDto).subscribe(data => {

      this.operationLock = false;
      this.toast(data.type, data.text);

      this.router.navigateByUrl('/settings/item-types');
