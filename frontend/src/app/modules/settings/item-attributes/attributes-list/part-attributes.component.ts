...
@Component({
  ...
  templateUrl: './part-attributes.component.html',
  styleUrls: ['./part-attributes.component.css'],
  providers: [VehicleService]
})


export class PartAttributesComponent implements OnInit, AfterViewInit {
  ...
  constructor(private readonly attrService: ItemAttributesService,
  ...
  public onEdit = (uuid) => {
    this.router.navigateByUrl('/settings/item-attribute/' + uuid);
  }
  public onAdd(): void {
    this.router.navigateByUrl('/settings/item-attribute');
  }
